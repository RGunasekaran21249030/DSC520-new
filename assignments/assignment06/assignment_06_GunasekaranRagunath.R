# Assignment: ASSIGNMENT 6 - Exercise 10: Regression with R
...
library("ggplot2")
ggplot(data = heights_df, aes(y = earn, x = age)) +  geom_point(color='blue') +
...
# References
# 1.  https://www.r-bloggers.com/2009/11/r-tutorial-series-simple-linear-regression/
